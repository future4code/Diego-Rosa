...
export class UserBusiness {
   ...
   constructor(
      ...
      // endpoint que permite receber um id e devolve as informações do usuário com esse id.
   ...
   // endpoint que permite a administradores verem todos os usuários do sistema.
   // Deve retornar um erro caso o usuário não seja admin.
   public async getAllUsers(role: UserRole) {
      if(stringToUserRole(role) !== UserRole.ADMIN) {
         throw new UnauthorizedError(
            "You must be an admin to acess this endpoint"
         )
      }
